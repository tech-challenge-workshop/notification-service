...
This repository intentionally contains no NestJS, RabbitMQ, SES, or persistence implementation yet. The approved system architecture is in the `fiap-x-platform` repository's `docs/foudation.md`.
